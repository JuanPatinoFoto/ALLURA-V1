...
export const teamMember = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'photo', title: 'Fotografía', type: 'image', options: { hotspot: true }, fields: [{ name: 'alt', title: 'Texto alt', type: 'string' }] }),
    defineField({ name: 'shortBio', title: 'Bio corta', type: 'object', fields: [{ name: 'es', title: 'Español', type: 'text', rows: 3, validation: (Rule) => Rule.max(200) }, { name: 'en', title: 'English', type: 'text', rows: 3, validation: (Rule) => Rule.max(200) }] }),
