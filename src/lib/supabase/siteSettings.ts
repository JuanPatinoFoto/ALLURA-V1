...
export async function getSiteSettings(): Promise<SiteSettings | null> {
  ...
  return {
    ...
    footerLegalPrivacyUrl: map.footer_legal_privacy_url as string | undefined,
    footerLegalTermsUrl: map.footer_legal_terms_url as string | undefined,
    footerLegalMedicalUrl: map.footer_legal_medical_url as string | undefined,
    footerLegalAccessUrl: map.footer_legal_access_url as string | undefined,
