...
export function TestimonialsForm({ settings, onChange }: { settings: Record<string, unknown>; onChange: (s: Record<string, unknown>) => void }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-gray-400 bg-gray-50 rounded p-2">Los testimonios se cargan automáticamente de la base de datos.</p>
